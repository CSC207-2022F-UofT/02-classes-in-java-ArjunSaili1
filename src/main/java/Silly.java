...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in 2 names as arguments and sets the
     * concatenation of them to name.
     *
     * @param nameA first name in concatnation.
     * @param nameB second name in concatnation.
     */
